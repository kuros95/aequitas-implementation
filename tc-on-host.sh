...
tc class add dev eth0 parent 1: classid 1:1 htb rate 2000mbps ceil 2000mbps

tc class add dev eth0 parent 1:1 classid 1:2 htb rate 400mbps ceil 2000mbps
tc class add dev eth0 parent 1:1 classid 1:3 htb rate 1400mbps ceil 2000mbps
tc class add dev eth0 parent 1:1 classid 1:4 htb rate 200mbps ceil 2000mbps
