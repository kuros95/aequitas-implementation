...
tc class add dev eth0 parent 1:1 classid 1:2 htb rate 400mbps ceil 1800mbps
tc class add dev eth0 parent 1:1 classid 1:3 htb rate 600mbps ceil 1800mbps
tc class add dev eth0 parent 1:1 classid 1:4 htb rate 200mbps ceil 1800mbps
