...
tc class add dev eth0 parent 1:1 classid 1:2 htb rate 30mbps ceil 100mbps
tc class add dev eth0 parent 1:1 classid 1:3 htb rate 20mbps ceil 100mbps
tc class add dev eth0 parent 1:1 classid 1:4 htb rate 10mbps ceil 100mbps
